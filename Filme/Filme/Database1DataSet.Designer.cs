...
namespace Filme {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public TableRow AddTableRow(int Id, string Nume, string Parola) {
...
namespace Filme.Database1DataSetTableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([Id], [Nume], [Parola]) VALUES (@Id, @Nume, @Parola);\r" +
                "\nSELECT Id, Nume, Parola FROM [Table] WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Table] SET [Id] = @Id, [Nume] = @Nume, [Parola] = @Parola WHERE (([" +
                "Id] = @Original_Id));\r\nSELECT Id, Nume, Parola FROM [Table] WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Filme.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        public virtual int Insert(int Id, string Nume, string Parola) {
        ...
        public virtual int Update(int Id, string Nume, string Parola, int Original_Id) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Nume, string Parola, int Original_Id) {
            return this.Update(Original_Id, Nume, Parola, Original_Id);
        }
    }
